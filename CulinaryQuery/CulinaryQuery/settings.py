"""
Django settings for CulinaryQuery project.
...
SECRET_KEY = 'django-insecure-y^q)(odz*-r*rppd&@1bjj!c(&w(_$&utk*+t$0rm@lbx3@w(w'
...
ROOT_URLCONF = 'CulinaryQuery.urls'
...
WSGI_APPLICATION = 'CulinaryQuery.wsgi.application'
